Ext.define('Arkivus.ImageViewer', {
    ...
    config:{
        ...
        this.imgEl.setStyle({
            '-webkit-user-drag':'none', '-webkit-transform-origin':'0 0', 'visibility':'hidden'
        });
        ...
        if (this.getPreviewSrc()) {
            this.element.setStyle({
                backgroundImage:'url(' + this.getPreviewSrc() + ')', backgroundPosition:'center center', backgroundRepeat:'no-repeat', webkitBackgroundSize:'contain'
            });
        }
        ...
        this.imgEl.addListener({
            scope:this, doubletap:this.onDoubleTap, pinchstart:this.onImagePinchStart, pinch:this.onImagePinch, pinchend:this.onImagePinchEnd
        });
