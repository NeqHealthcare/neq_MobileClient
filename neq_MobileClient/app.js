...
//    viewport:{ xclass: 'NeqMobile.view.Viewport'},
    ...
    controllers:['General', 'Session', 'NeqMobile.controller.settings.Domains', 'Workspace','PatientInfo','PatientLab','DoctorDashboard'],
    views:['NeqMobile.view.settings.Domains', 'Viewport', 'NeqMobile.view.patient.PatientList', 'NeqMobile.view.patient.PatientInfo','NeqMobile.view.doctor.DoctorDashboard', 'Workspace'],
